...
if __name__ == "__main__":
    ...
    o,a,b,c = generation_world_map(*asu)

    o.save("data/worlds/1/land.png")
    np.save("data/worlds/1/land.npy", a)
    np.save("data/worlds/1/fossils.npy", b)
    np.save("data/worlds/1/forest.npy", c)
